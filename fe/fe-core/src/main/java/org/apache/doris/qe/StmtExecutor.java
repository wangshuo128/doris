...
public class StmtExecutor implements ProfileWriter {
    ...
    private void parse() throws AnalysisException, DdlException {
        LOG.info("StmtExecutor start to parse");
        // parsedStmt may already by set when constructing this StmtExecutor();
        if (parsedStmt == null) {
            long startNano = System.nanoTime();
            // long startTime = System.currentTimeMillis();
            // Parse statement with parser generated by CUP&FLEX
            LOG.info("origin stmt: {}", originStmt.originStmt);
            // System.out.println("origin stmt: " + originStmt.originStmt);
            ...
            // LOG.error("====SQL parse time: {} ms====", (System.currentTimeMillis() - startTime));
            System.out.println(String.format("==SQL parse time: %.2f ms===",
                (System.nanoTime() - startNano) / 1000.0 / 1000.0));
            analyzeVariablesInStmt();
        }
