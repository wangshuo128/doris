...
#include "recycler/hdfs.h" // IWYU pragma: keep

// TODO: move to hdfs_util.h
struct hdfsBuilder;
...
class HDFSCommonBuilder {
    friend int create_hdfs_builder(const THdfsParams& hdfsParams, const std::string& fs_name,
                                   HDFSCommonBuilder* builder);
    friend int create_hdfs_builder(const std::map<std::string, std::string>& properties,
                                   HDFSCommonBuilder* builder);
...
int create_hdfs_builder(const THdfsParams& hdfsParams, HDFSCommonBuilder* builder);
